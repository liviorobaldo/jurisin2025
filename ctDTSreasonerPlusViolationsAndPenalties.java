...
public class ctDTSreasonerPlusViolationsAndPenalties 
{
    private static File ctDTSfile = new File("./ctDTS.ttl");
    private static File ctViolationsAndPenaltiesfile = new File("./VaP.ttl");
    private static File SOAfile = new File("./Examples/Example5.ttl");
    private static File inferredTriplesFile = new File("./inferredABox.ttl");
    ...
    public static void main(String[] args) throws Exception 
    {
        if(args.length==4)
        {
            ...
            ctViolationsAndPenaltiesfile = new File(args[1]);
            SOAfile = new File(args[2]);
            inferredTriplesFile = new File(args[3]);
        }
        ...
        fis.close();
        fis = new FileInputStream(ctViolationsAndPenaltiesfile);
        model.read(fis, "urn:dummy", FileUtils.langTurtle);
        fis.close();
